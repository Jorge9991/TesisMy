...
//obtengo el correo     
        ...
        try {
            ...
            $message .= "<thead>
  <tr height='80'>
  <th colspan='4' style='background-color:#f5f5f5; border-bottom:solid 1px #bdbdbd; font-family:Verdana, Geneva, sans-serif; color:#333; font-size:34px;' >Tesis aprobada!</th>
  </tr>
             </thead>";
       ...
       <p style='font-size:20px;'>Su Tesis ha sido aprobada</p>
       <hr />
