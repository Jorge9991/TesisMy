                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="asignacion.php" class="btn btn-outline-info float-left mr-3">Regresar a listado</a>
                                    <?php if ($status[0] == 5) { ?>
                                        <form  role="form" id="frmTesisCancelar" class="float-left mr-3">  
                                            ...
                                            <input type="hidden" name="action" id="_action" value="cc">
                                            <input type="hidden" name="idequipo" id="_idequipo" value="<?= $idequipo ?>"/>                                    
                                            <input type="hidden" name="opc" id="_opc" value="CC"/>
                                        </form>
                                    <?php } ?>
                                    <?php if ($status[0] != 5) { ?>
