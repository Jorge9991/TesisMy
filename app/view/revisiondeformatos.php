...
<html>
    <head>
        ...
        <title>Revision de formatos</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de estudiantes con formatos</strong>  
                                </div>
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuarioformatos = ctrUsuarioFormato::getUsuarioformatos();
                                            $usuarioformatos2 = ctrUsuarioFormato::getUsuarioformatos2();
                                            $usuariosformato1y2 = array_merge($usuarioformatos, $usuarioformatos2);
                                            foreach ($usuariosformato1y2 as $usuarioformato) {

                                                $id = $usuarioformato->getIdequipo();
                                                ?>
                                                <tr>

                                                    <td align="center"> <?= $usuarioformato->getIdequipo() ?> </td>
                                                    <td align="center"> <?= $usuarioformato->getNombres() ?> </td>


                                                    <?php if ($usuarioformato->getStatus() == 2) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-primary">Por revisar</span></td>
                                                    <?php } ?>
                                                    <?php if ($usuarioformato->getStatus() == 3) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Aprobado</span> </td>
                                                    <?php } ?>
                                                    <?php if ($usuarioformato->getStatus() == 4) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> No aprobado</span>  </td>
                                                    <?php } ?>

                                                    <td align="center">
                                                        <form action="formatousuario.php" role="form" " method="POST"  >
                                                            <input type="hidden" name="idusuarioformato" id="idusuarioformato" value="<?= $usuarioformato->getIdequipo() ?>"/>
