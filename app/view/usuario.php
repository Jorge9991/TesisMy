                                            ...
                                            <form role="form" id="frmUsuario" class="form-horizontal" >
                                                <div class="modal-body">
                                                    <div class="card-body card-block">
                                                        ...
                                                        <div class="row form-group">
                                                            <div class="col col-sm-6"><input type="text" id="_telefono" name="telefono" placeholder="Teléfono"  class="form-control"></div>
                                                            <div class="col col-sm-6"><input type="text" id="_direccion" name="direccion" placeholder="Dirección"  class="form-control"></div>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-sm-6"><input type="text" id="_usuario" name="usuario" placeholder="Usuario"  class="form-control"></div>
                                                            <div class="col col-sm-6"><input type="password" id="_contrasena" name="contrasena" placeholder="Contraseña"  class="form-control"></div>
                                                        </div>
                                                        <div class="row form-group">
