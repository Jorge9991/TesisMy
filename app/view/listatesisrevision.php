                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de estudiantes con Tesis por revisar</strong>  
                                </div>
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuariotesis = ctrUsuarioTesis::getlistadetesis($idusuario);
                                            $usuariotesis2 = ctrUsuarioTesis::getlistadetesis2($idusuario);
                                            ...
                                            foreach ($usuariotesis1y2 as $usuariotesi) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($usuariotesi->getStatus() == 3) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Tesis por revisar</span> </td>
                                                    <?php } ?>
                                                    <?php if ($usuariotesi->getStatus() == 5) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> tesis con observaciones</span> </td>
                                                    <?php } ?>

                                                    <td align="center">
                                                        <form action="correcion.php" role="form" " method="POST"  >
                                                            <input type="hidden" name="idusuarioanteproyecto" id="idusuarioanteproyecto" value="<?= $usuariotesi->getIdequipo() ?>"/>
                                                            <button type="submit" class="btn btn-outline-info"> Agregar observaciones </button> 
                                                        </form>
                                                    </td>
                                                </tr>   
                                                <?php
