...
<html>
    <head>
        ...
        <title>Tesis por calificar</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de estudiantes con Tesis por calificar</strong>  
                                </div>
                                <div class="card-body">
...
<!--                                                <th>Tema</th>-->
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuariotesis = ctrUsuarioTesis::getlistanotadetesis($idusuario);
                                            $usuariotesis2 = ctrUsuarioTesis::getlistanotadetesis2($idusuario);
                                            ...
                                            foreach ($usuariotesis1y2 as $usuariotesi) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    $notas = ctrNota::getNotas($idusuario, $usuariotesi->getIdequipo());
                                                    if (!$notas) {
                                                        ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Por calificar</span> </td>
                                                    <?php } ?>
                                                    <?php if ($notas) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> Calificada</span> </td>
                                                    <?php } ?>

                                                    <td align="center">
                                                        <form action="calificarusuario.php" role="form" " method="POST">
