...
<html>
    <head>
        ...
        <title>Revision de Anteproyectos</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de estudiantes con Anteproyectos</strong>  
                                </div>
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuarioanteproyectos = ctrUsuarioAnteproyecto::getUsuarioAnteproyecto();
                                            $usuarioanteproyectos2 = ctrUsuarioAnteproyecto::getUsuarioanteproyecto2();
                                            ...
                                            foreach ($usuarioanteproyectos1y2 as $usuarioanteproyecto) {
                                                ...
                                                $id = $usuarioanteproyecto->getIdequipo();
                                                ?>
                                                <tr>

                                                    <td align="center"> <?= $usuarioanteproyecto->getIdequipo() ?> </td>
                                                    <td align="center"> <?= $usuarioanteproyecto->getNombres() ?> </td>


                                                    <?php if ($usuarioanteproyecto->getStatus() == 2) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-primary">Por revisar</span></td>
                                                    <?php } ?>
                                                    <?php if ($usuarioanteproyecto->getStatus() == 3) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Aprobado</span> </td>
                                                    <?php } ?>
                                                    <?php if ($usuarioanteproyecto->getStatus() == 4) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> No aprobado</span>  </td>
                                                    <?php } ?>

                                                    <td align="center">
                                                        <form action="formatoanteproyecto.php" role="form" " method="POST"  >
                                                            <input type="hidden" name="idusuarioanteproyecto" id="idusuarioanteproyecto" value="<?= $usuarioanteproyecto->getIdequipo() ?>"/>
