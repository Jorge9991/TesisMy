                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de grupos con calificaciones</strong>  
                                </div>
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $calificacion = ctrUsuarioNota::getUsuarionota();
                                            $calificacion2 = ctrUsuarioNota::getUsuarionota2();
                                            $calificaciones = array_merge($calificacion, $calificacion2);

                                            foreach ($calificaciones as $calificacion) {
                                                ?>
                                                <tr>

                                                    <td align="center"> <?= $calificacion->getIdequipo() ?> </td>
                                                    <td align="center"> <?= $calificacion->getNombres() ?> </td>
                                                    <td align="center"> <?php echo bcdiv($calificacion->getNota() / 3, '1', 2) ?> </td>
                                                </tr>   
                                                <?php
                                            }
                                            ?>
