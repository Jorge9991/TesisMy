                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuariotesis = ctrUsuarioTesis::getlistacorreciondetesis($idusuario);
                                            $usuariotesis2 = ctrUsuarioTesis::getlistacorreciondetesis2($idusuario);
                                            ...
                                            foreach ($usuariotesis1y2 as $usuariotesi) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($usuariotesi->getStatus() == 6) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Revisar</span> </td>
                                                    <?php } ?>
                                                    <?php if ($usuariotesi->getStatus() == 7) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> Aprobada</span> </td>
                                                    <?php } ?>

                                                    <td align="center">
                                                        <form action="revisioncorreciontesis.php" role="form" " method="POST"  >
