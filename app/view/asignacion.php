...
<html>
    <head>
        ...
        <title>Asignación de pares ciego</title>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title ">Lista de estudiantes con Tesis</strong>  
                                </div>
                                <div class="card-body">
                                    <table id="tdatos" class="table table-striped table-bordered">
                                        ...
                                        <tbody id="tdetalle">
                                            <?php
                                            $usuariotesis = ctrUsuarioTesis::getUsuariotesis();
                                            $usuariotesis2 = ctrUsuarioTesis::getUsuariotesis2();
                                            ...
                                            foreach ($usuariotesis1y2 as $usuariotesi) {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($usuariotesi->getStatus() == 2) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-primary">Por asignar</span></td>
                                                    <?php } ?>
                                                    <?php if ($usuariotesi->getStatus() == 3) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-success"> Asignado pares ciego</span> </td>
                                                    <?php } ?>
                                                    <?php if ($usuariotesi->getStatus() == 4) { ?>
                                                        <td align="center"><span class="badge badge-pill badge-danger"> No asignado</span> </td>
    <?php } ?>

                                                    <td align="center">
                                                        <form action="formatotesis.php" role="form" " method="POST"  >
