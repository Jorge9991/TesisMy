...
try {
    ...
    $sql = "INSERT INTO `tb_tesis` (  `iddrive`, `nombrearchivo`, `ruta`, `extension`, `status`, `idequipo`) "
            . "VALUES ( '$iddrive', '$nombre','$ruta','$extension',2, '$idequipo')";
...
header('Location: ../view/notasustentacion.php');
