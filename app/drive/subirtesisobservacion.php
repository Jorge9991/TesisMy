...
try {
    ...
    $sql = "INSERT INTO `tb_tesis` (  `iddrive`, `nombrearchivo`, `ruta`, `extension`, `status`, `idequipo`,`iduserobservacion`) "
            . "VALUES ( '$iddrive', '$nombre','$ruta','$extension',5, '$idequipo', '$idusuario')";
