...
try {
    ...
    $sql = "INSERT INTO `documentos` (  `iddrive`, `nombredelarchivo`, `ruta`, `extension`, `categoria`) "
            . "VALUES ( '$iddrive', '$nombre','$ruta','$extension', '$categoria')";
...
header('Location: ../view/formatos.php');
